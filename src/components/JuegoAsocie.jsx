...
const pares = [
  { id: 1, concepto: 'Tarjeta modular', categoria: 'Visual' },
  { id: 2, concepto: 'Secuencia narrativa', categoria: 'Narrativa' },
  { id: 3, concepto: 'Flujo técnico', categoria: 'Simulador' },
  { id: 4, concepto: 'Retroalimentación inmediata', categoria: 'Simulador' },
  { id: 5, concepto: 'Exploración guiada', categoria: 'Narrativa' },
  { id: 6, concepto: 'Clasificación libre', categoria: 'Visual' },
];
...
export default function JuegoAsocie({ activarJuego }) {
  ...
  const iniciarJuego = () => {
    ...
    activarJuego(); // Oculta fichas desde el padre
    setSeleccionados([]);
    setModalError(false);
